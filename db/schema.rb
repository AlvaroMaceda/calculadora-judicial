...
ActiveRecord::Schema.define(version: 2020_04_21_210956) do
  ...
  create_table "autonomous_communities", id: false, force: :cascade do |t|
    t.string "code", limit: 2
    t.string "name"
    t.integer "country_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["code"], name: "index_autonomous_communities_on_code", unique: true
  ...
  create_table "municipalities", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "autonomous_communities_id"
    t.index ["autonomous_communities_id"], name: "index_municipalities_on_autonomous_communities_id"
    t.index ["code"], name: "index_municipalities_on_code", unique: true
  end

  add_foreign_key "autonomous_communities", "countries"
  add_foreign_key "municipalities", "autonomous_communities", column: "autonomous_communities_id", primary_key: "code"
end
