class Api::DeadlineCalculatorController < ApplicationController
    ...
    def deadline()
        ...
        municipality = Territory.settlements.find_by(code: @municipality_code)
        ...
        @missing_holidays = municipality.holidays_missing_between(@notification_date.year,@deadline.year)
    end
